...
public class InitBattleState : IBattleState
{
	...
	public void EnterState()
	{
		...
		{
			SpawnUnit(new Unit("Ally1", Alliances.Ally, 5), new Vector3(0f, -2.936f, 0f)),
			SpawnUnit(new Unit("Ally1", Alliances.Ally, 5), new Vector3(2f, -2.936f, 0f)),
			// SpawnUnit(new Unit("Ally1", Alliances.Ally, 5), new Vector3(3f, -2.936f, 0f)),
			SpawnUnit(new Unit("Foe1", Alliances.Foe, 3), new Vector3(7f, -2.936f, 0f)),
			SpawnUnit(new Unit("Foe2", Alliances.Foe, 5), new Vector3(9f, -2.936f, 0f))
		};
